...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/minesweeper-classic.git
   cd minesweeper-classic
   ```
...
[![Repo](https://img.shields.io/badge/minesweeper-classic-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/minesweeper-classic)
